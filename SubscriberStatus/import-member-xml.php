...
// BEGIN - Variables Set for use in the XML transmission  -- Access Development MetaData
$orgCustId = "2002214";
...
$MemberID =  "SRP" . str_pad($nextId, 5, '0', STR_PAD_LEFT);
// END - Variables Set for use in the XML transmission  -- Access Development MetaData
...
if ($existingID == 0 )
{
    ...
    if ($status == "imported") {
        ...
        $eml->FromName = "Subscriber Rewards - Support Department";
        $eml->From = "support@cmgms.com";

        $eml->MsgHTML($admMessage);
        $eml->Subject = "Subscriber Rewards - User submitted - XML";
        $eml->Send();
...
else
{
    ...
    $admMessage .= "<body><p>The following user was submitted for the Subscriber Rewards system</p>";
    $admMessage .= "<table cellspacing=0 cellpadding=3 border=1>";
    $admMessage .= "<tr>";
    $admMessage .= "<td>Existing ID</td><td>" . "SRP" . str_pad($existingID, 7, '0', STR_PAD_LEFT)  . "</td>";
    $admMessage .= "</tr>";
    $admMessage .= "<tr>";
    $admMessage .= "<td>First Name</td><td>" . $firstname . "</td>";
    $admMessage .= "</tr>";
...
//  Email to Admin User for Property
    $eml->AddAddress("markmatusek74@gmail.com");
    $eml->AddAddress("zpayer@cmgms.com");
    $eml->FromName = "Subscriber Rewards - Support Department - XML ";
    $eml->From = "support@thompsonhealth.com";

    $eml->MsgHTML($admMessage);
    $eml->Subject = "Subscriber Rewards - USER ALREADY EXISTS ";
    $eml->Send();
    ...
    <div class="container">
        ...
        <div class="wrapper">
            <div class="signup1">
                ...
                <p>Thank you for applying for your Subscriber Savings member ID.  Please use the following information to register your account.<br><br>

                    <b>Register at:</b><br>
                    <a href="https://subscribersavings.enjoymydeals.com/home?register=true" target="_blank">subscribersavings.net</a><br><br>
                    ...
                    <b>Phone Number:</b><br>
                    <? print $_POST["phone"]; ?><br><br>

                    <b>Publication:</b><br>
                    <? print $_POST["publication"]; ?>
                </p>
            </div>
            <div class="registerimg">
                <img src="./img/ss-register-screenshot.png" width="400px">
            </div>
        </div>
    </div>
